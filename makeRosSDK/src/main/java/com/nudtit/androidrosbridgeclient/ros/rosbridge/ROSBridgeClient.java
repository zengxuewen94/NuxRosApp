 ...
 * 
 */
package com.nudtit.androidrosbridgeclient.ros.rosbridge;
...
import com.nudtit.androidrosbridgeclient.ros.rosapi.message.*;
import com.nudtit.androidrosbridgeclient.ros.rosbridge.implementation.*;
import com.nudtit.androidrosbridgeclient.ros.rosbridge.operation.*;
...
public class ROSBridgeClient extends ROSClient {
    ...
    private String getServiceType(String service) throws InterruptedException {
        Service<com.nudtit.androidrosbridgeclient.ros.rosapi.message.Service, Type> serviceTypeService =
                new Service<com.nudtit.androidrosbridgeclient.ros.rosapi.message.Service, Type>("/rosapi/service_type",
                    com.nudtit.androidrosbridgeclient.ros.rosapi.message.Service.class, Type.class, this);
        return serviceTypeService.callBlocking(new com.nudtit.androidrosbridgeclient.ros.rosapi.message.Service(service)).type;
    }
