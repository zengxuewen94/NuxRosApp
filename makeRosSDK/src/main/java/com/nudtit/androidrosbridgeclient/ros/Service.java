...
import com.nudtit.androidrosbridgeclient.ros.rosbridge.operation.CallService;
import com.nudtit.androidrosbridgeclient.ros.rosbridge.operation.ServiceResponse;
import com.nudtit.androidrosbridgeclient.ros.rosbridge.FullMessageHandler;

import java.util.Map;
import java.util.HashMap;
import java.util.concurrent.CountDownLatch;

import static com.nudtit.androidrosbridgeclient.ros.message.Message.getMessageType;
...
public class Service<CallType extends Message, ResponseType extends Message> implements FullMessageHandler {
    ...
    private String callImpl(CallType args, MessageHandler<ResponseType> responseHandler) {
        ...
        CallService messageCallService = new CallService(service, args,getMessageType(callType),getMessageType(responseType));
