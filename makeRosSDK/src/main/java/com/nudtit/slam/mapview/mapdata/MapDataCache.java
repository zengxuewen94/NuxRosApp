package com.nudtit.slam.mapview.mapdata;
...
import com.nudtit.slam.utils.PointTranslateUtil;
...
public final class MapDataCache {
    ...
    public com.nudtit.slam.bean.PointF mapPixelCoordinateToMapCoordinate(Point pixel) {
        PointF offset = new PointF(pixel.x * mResolution.x, (mDimension.getHeight() - pixel.y) * mResolution.y);
        return new com.nudtit.slam.bean.PointF(mBaseCoordinate.x + offset.x, mBaseCoordinate.y + offset.y);
    }

    final public com.nudtit.slam.bean.PointF mapPixelCoordinateToMapCoordinate(PointF pixel) {
        PointF offset = new PointF(pixel.x * mResolution.x, (mDimension.getHeight() - pixel.y) * mResolution.y);
        return new com.nudtit.slam.bean.PointF(mBaseCoordinate.x + offset.x, mBaseCoordinate.y + offset.y);
    }
