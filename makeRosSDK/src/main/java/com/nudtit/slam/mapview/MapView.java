package com.nudtit.slam.mapview;
...
import com.nudtit.slam.bean.Line;
...
import com.nudtit.slam.mapview.mapdata.MapDataCache;
import com.nudtit.slam.robot.Map;
import com.nudtit.slam.utils.MathUtils;
import com.nudtit.slam.utils.RadianUtil;
import com.nudtit.slam.utils.SlamGestureDetector;
...
public class MapView extends FrameLayout implements SlamGestureDetector.OnRPGestureListener {
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////
    protected com.nudtit.slam.bean.PointF widthCoordinateToMapCoordinate(float x, float y) {
    ...
    public com.nudtit.slam.bean.PointF widgetCoordinateToMapCoordinate(PointF widgetPointF) {
        Matrix m = mOuterMatrix;
        float[] points = new float[]{widgetPointF.x, widgetPointF.y};
        float[] values = MathUtils.inverseMatrixPoint(m, points);
        com.nudtit.slam.bean.PointF point = mMapData.mapPixelCoordinateToMapCoordinate(new PointF(values[0], values[1]));
        return point;
    }

    public com.nudtit.slam.bean.PointF widgetCoordinateToMapCoordinate(float x, float y) {
        Matrix m = mOuterMatrix;
    ...
    public PointF mapCoordinateToWidthCoordinateF(com.nudtit.slam.bean.PointF mapPointF) {
        synchronized (mMapData) {
    ...
    public Point mapCoordinateToWidthCoordinate(com.nudtit.slam.bean.PointF mapPointF) {
        synchronized (mMapData) {
            PointF mapPixelPointF = mMapData.mapCoordinateToMapPixelCoordinateF(mapPointF.getX(), mapPointF.getY());
    ...
    public PointF mapCoordinateToMapPixelCoordinateF(com.nudtit.slam.bean.PointF mapPointF) {
        PointF mapPixelPointF = mMapData.mapCoordinateToMapPixelCoordinateF(mapPointF.getX(), mapPointF.getY());
