 ...
 */
package com.zhh.androidrosbridgeclient.ros;

import com.zhh.androidrosbridgeclient.ros.message.Log;
...
import com.zhh.androidrosbridgeclient.ros.rosapi.message.GetTime;
import com.zhh.androidrosbridgeclient.ros.rosapi.message.MessageDetails;
import com.zhh.androidrosbridgeclient.ros.rosapi.message.Type;
...
public class Example {
    ...
    public static void testService(ROSBridgeClient client) {
        try {
            ...
            Service<com.zhh.androidrosbridgeclient.ros.rosapi.message.Service, Type> serviceTypeService =
                    new Service<>("/rosapi/service_type",
                            com.zhh.androidrosbridgeclient.ros.rosapi.message.Service.class, Type.class, client);
            serviceTypeService.verify();
            String type = serviceTypeService.callBlocking(new com.zhh.androidrosbridgeclient.ros.rosapi.message.Service("/rosapi/service_response_details")).type;
            ...
            com.zhh.androidrosbridgeclient.ros.Topic<Log> logTopic =
                    new com.zhh.androidrosbridgeclient.ros.Topic<Log>("/rosout", Log.class, client);
            logTopic.verify();
