...
public class RulerView extends View implements ScrollChange {
    ...
    private void init(Context context) {
        ...
        mTextPaint.setColor(ContextCompat.getColor(context, R.color.blue_color));
        ...
        mLinePaint.setColor(ContextCompat.getColor(context, R.color.blue_color));
    ...
    private void drawRuler(Canvas canvas) {
        mTextIndex = 0;
        LogUtils.d("TAG","index:"+mRulerHelper.getCounts());
        ...
        for (int index = 0; index <= mRulerHelper.getCounts(); index++) {
            ...
            mRect.left = index * mLineSpace + lineCount ;
        ...
        canvas.drawLine(0, getHeight(), mRulerHelper.getCounts()*(mLineWidth+mLineSpace), getHeight(), mLinePaint);
        LogUtils.d("tag","中间位置："+(mRulerHelper.getCounts()*(mLineWidth+mLineSpace)));
    }
    ...
    public void scrollFinish() {
        ...
        LogUtils.d("TAG",finalX+"**"+centerPointX+"**"+currentX+"**"+scrollDistance);
