...
public final class ActivityManager implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(@NonNull Activity activity, @Nullable Bundle savedInstanceState) {
        LogUtils.i("%s - onCreate", activity.getClass().getSimpleName());
    ...
    public void onActivityStarted(@NonNull Activity activity) {
        LogUtils.i("%s - onStart", activity.getClass().getSimpleName());
        mLastVisibleTag = getObjectTag(activity);
    }

    @Override
    public void onActivityResumed(@NonNull Activity activity) {
        LogUtils.i("%s - onResume", activity.getClass().getSimpleName());
        mLastVisibleTag = getObjectTag(activity);
    }

    @Override
    public void onActivityPaused(@NonNull Activity activity) {
        LogUtils.i("%s - onPause", activity.getClass().getSimpleName());
        mLastInvisibleTag = getObjectTag(activity);
    }

    @Override
    public void onActivityStopped(@NonNull Activity activity) {
        LogUtils.i("%s - onStop", activity.getClass().getSimpleName());
        mLastInvisibleTag = getObjectTag(activity);
    }

    @Override
    public void onActivitySaveInstanceState(@NonNull Activity activity, @NonNull Bundle outState) {
        LogUtils.i("%s - onSaveInstanceState", activity.getClass().getSimpleName());
    }

    @Override
    public void onActivityDestroyed(@NonNull Activity activity) {
        LogUtils.i("%s - onDestroy", activity.getClass().getSimpleName());
