...
import com.nudtit.lib_common.base.action.ActivityAction;
import com.nudtit.lib_common.base.action.AnimAction;
import com.nudtit.lib_common.base.action.ClickAction;
...
/**
 * @author :  zengxuewen（外部引入https://github.com/getActivity/AndroidProject）
 * @date :  2021/6/17
 * @desc :  Dialog 基类
 */
public class BaseNewDialog extends AppCompatDialog implements LifecycleOwner,
    ...
    private List<BaseNewDialog.OnCancelListener> mCancelListeners;
    private List<BaseNewDialog.OnDismissListener> mDismissListeners;
    ...
    public int getWindowAnimations() {
        ...
        return BaseNewDialog.ANIM_DEFAULT;
    }
     ...
     * @deprecated 请使用 {@link #addOnShowListener(BaseNewDialog.OnShowListener)}}
     */
    @Deprecated
    @Override
     ...
     * @deprecated 请使用 {@link #addOnCancelListener(BaseNewDialog.OnCancelListener)}
     */
    @Deprecated
    @Override
     ...
     * @deprecated 请使用 {@link #addOnDismissListener(BaseNewDialog.OnDismissListener)}
     */
    @Deprecated
    @Override
     ...
     * @deprecated 请使用 {@link #setOnKeyListener(BaseNewDialog.OnKeyListener)}
     */
    @Deprecated
    @Override
    ...
    public void setOnKeyListener(@Nullable BaseNewDialog.OnKeyListener listener) {
     ...
     */
    public void addOnShowListener(@Nullable BaseNewDialog.OnShowListener listener) {
     ...
     * @param listener 监听器对象
     */
    public void addOnCancelListener(@Nullable BaseNewDialog.OnCancelListener listener) {
     ...
     * @param listener 监听器对象
     */
    public void addOnDismissListener(@Nullable BaseNewDialog.OnDismissListener listener) {
     ...
     * @param listener 监听器对象
     */
    public void removeOnShowListener(@Nullable BaseNewDialog.OnShowListener listener) {
        if (mShowListeners != null) {
     ...
     * @param listener 监听器对象
     */
    public void removeOnCancelListener(@Nullable BaseNewDialog.OnCancelListener listener) {
        if (mCancelListeners != null) {
     ...
     * @param listener 监听器对象
     */
    public void removeOnDismissListener(@Nullable BaseNewDialog.OnDismissListener listener) {
        if (mDismissListeners != null) {
     ...
     * 设置显示监听器集合
     */
    private void setOnShowListeners(@Nullable List<BaseNewDialog.OnShowListener> listeners) {
        super.setOnShowListener(mListeners);
     ...
     * 设置取消监听器集合
     */
    private void setOnCancelListeners(@Nullable List<BaseNewDialog.OnCancelListener> listeners) {
        super.setOnCancelListener(mListeners);
     ...
     * 设置销毁监听器集合
     */
    private void setOnDismissListeners(@Nullable List<BaseNewDialog.OnDismissListener> listeners) {
        super.setOnDismissListener(mListeners);
    ...
    public static class Builder<B extends Builder> implements
        ...
        /** 动画样式 */
        private int mAnimStyle = BaseNewDialog.ANIM_DEFAULT;
        /** 重心位置 */
        ...
        /** Dialog 创建监听 */
        private BaseNewDialog.OnCreateListener mCreateListener;
        /** Dialog 显示监听 */
        private List<BaseNewDialog.OnShowListener> mShowListeners = new ArrayList<>();
        /** Dialog 取消监听 */
        private List<BaseNewDialog.OnCancelListener> mCancelListeners = new ArrayList<>();
        /** Dialog 销毁监听 */
        private List<BaseNewDialog.OnDismissListener> mDismissListeners = new ArrayList<>();
        /** Dialog 按键监听 */
        private BaseNewDialog.OnKeyListener mKeyListener;
         ...
         * 设置创建监听
         */
        public B setOnCreateListener(@NonNull BaseNewDialog.OnCreateListener listener) {
         ...
         * 添加显示监听
         */
        public B addOnShowListener(@NonNull BaseNewDialog.OnShowListener listener) {
            mShowListeners.add(listener);
            return (B) this;
        }
         ...
         * 添加取消监听
         */
        public B addOnCancelListener(@NonNull BaseNewDialog.OnCancelListener listener) {
            mCancelListeners.add(listener);
            return (B) this;
        }
         ...
         * 添加销毁监听
         */
        public B addOnDismissListener(@NonNull BaseNewDialog.OnDismissListener listener) {
            mDismissListeners.add(listener);
            return (B) this;
        }
         ...
         * 设置按键监听
         */
        public B setOnKeyListener(@NonNull BaseNewDialog.OnKeyListener listener) {
         ...
         * 设置点击事件
         */
        public B setOnClickListener(@IdRes int id, @NonNull BaseNewDialog.OnClickListener listener) {
            if (mClickArray == null) {
        ...
        public BaseNewDialog create() {
            ...
            if (mAnimStyle == BaseNewDialog.ANIM_DEFAULT) {
                switch (mGravity) {
                    case Gravity.TOP:
                        mAnimStyle = BaseNewDialog.ANIM_TOP;
                        break;
                    case Gravity.BOTTOM:
                        mAnimStyle = BaseNewDialog.ANIM_BOTTOM;
                        break;
                    case Gravity.LEFT:
                        mAnimStyle = BaseNewDialog.ANIM_LEFT;
                        break;
                    case Gravity.RIGHT:
                        mAnimStyle = BaseNewDialog.ANIM_RIGHT;
                        break;
                    default:
                        mAnimStyle = BaseNewDialog.ANIM_DEFAULT;
                        break;
                }
            }
         ...
         */
        @NonNull
        protected BaseNewDialog createDialog(Context context, @StyleRes int themeId) {
            return new BaseNewDialog(context, themeId);
        }
         ...
         * 获取当前 Dialog 对象
         */
        public BaseNewDialog getDialog() {
            return mDialog;
        }
    }
    ...
    private static final class DialogLifecycle implements
            ...
            BaseNewDialog.OnShowListener,
            BaseNewDialog.OnDismissListener {

        private static void with(Activity activity, BaseNewDialog dialog) {
        ...
        private DialogLifecycle(Activity activity, BaseNewDialog dialog) {
            mActivity = activity;
        ...
        public void onActivityPaused(@NonNull Activity activity) {
            ...
            if (mDialog != null && mDialog.isShowing()) {
                ...
                // 设置 Dialog 无动画效果
                mDialog.setWindowAnimations(BaseNewDialog.ANIM_EMPTY);
            }
        }
        ...
        @Override
        public void onShow(BaseNewDialog dialog) {
            mDialog = dialog;
    ...
    private static final class ViewClickWrapper
        ...
        private final BaseNewDialog mDialog;
        private final BaseNewDialog.OnClickListener mListener;

        private ViewClickWrapper(BaseNewDialog dialog, BaseNewDialog.OnClickListener listener) {
            mDialog = dialog;
            mListener = listener;
        }
    ...
    private static final class ShowListenerWrapper
            ...
            implements BaseNewDialog.OnShowListener {
    ...
    private static final class CancelListenerWrapper
            ...
            implements BaseNewDialog.OnCancelListener {
    ...
    private static final class DismissListenerWrapper
            ...
            implements BaseNewDialog.OnDismissListener {
    ...
    private static final class KeyListenerWrapper
        ...
        private final BaseNewDialog.OnKeyListener mListener;

        private KeyListenerWrapper(BaseNewDialog.OnKeyListener listener) {
            mListener = listener;
        }
        ...
        public boolean onKey(DialogInterface dialog, int keyCode, KeyEvent event) {
            // 在横竖屏切换后监听对象会为空
            if (mListener != null && dialog instanceof BaseNewDialog) {
                return mListener.onKey((BaseNewDialog) dialog, event);
            }
            return false;
        }
    }
    ...
    public interface OnClickListener<V extends View> {
        void onClick(BaseNewDialog dialog, V view);
    }
    ...
    public interface OnCreateListener {
         ...
         * Dialog 创建了
         */
        void onCreate(BaseNewDialog dialog);
    }
    ...
    public interface OnShowListener {
         ...
         * Dialog 显示了
         */
        void onShow(BaseNewDialog dialog);
    }
    ...
    public interface OnDismissListener {
         ...
         * Dialog 销毁了
         */
        void onDismiss(BaseNewDialog dialog);
    }
    ...
    public interface OnKeyListener {
         ...
         * 触发了按键
         */
        boolean onKey(BaseNewDialog dialog, KeyEvent event);
    }
}
