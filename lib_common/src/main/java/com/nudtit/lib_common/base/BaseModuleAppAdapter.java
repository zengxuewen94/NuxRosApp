 ...
 */
public abstract class BaseModuleAppAdapter<T> extends BaseAdapter<BaseAdapter<?>.BaseViewHolder> {
    ...
    public BaseModuleAppAdapter(@NonNull Context context) {
        super(context);
    }
    ...
    public final class SimpleHolder extends BaseViewHolder {
