...
public class MapHelper {
    ...
    public MapHelper(WeakReference<Context> contextWeakReference, WeakReference<ConnectActivity> activityWeakReference, WeakReference<MapView> mapViewWeakReference) {
