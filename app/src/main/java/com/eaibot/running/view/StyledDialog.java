...
import com.eaibot.running.view.dialog.DialogAssigner;
import com.eaibot.running.view.dialog.DialogAssignerRecycler;
...
public class StyledDialog {
    ...
    public static ConfigBeanRecycler buildBottomSheetGvReCycler(CharSequence title, List datas, CharSequence bottomTxt, int columnsNum , MyItemDialogListener listener){
        return DialogAssignerRecycler.getInstance().assignBottomSheetGv(null,title,datas,bottomTxt,columnsNum,listener);
    }
