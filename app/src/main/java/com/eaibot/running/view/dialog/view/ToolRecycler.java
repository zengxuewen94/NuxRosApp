...
import com.eaibot.running.view.dialog.MyActyManager;
...
public class ToolRecycler {
    ...
    public static void setMdBtnStytle(ConfigBeanRecycler bean){
        Button btnPositive =
    ...
    public static ConfigBeanRecycler fixContext(ConfigBeanRecycler bean){
    ...
    public static ConfigBeanRecycler newCustomDialog(ConfigBeanRecycler bean){
        AppCompatDialog dialog = new AppCompatDialog(bean.context);
        dialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
        bean.dialog = dialog;
        return bean;
    }

    public static ConfigBeanRecycler setCancelable(ConfigBeanRecycler bean){
    ...
    public static void setDialogStyle(ConfigBeanRecycler bean) {
        if (bean.alertDialog!= null){
            setMdBtnStytle(bean);
        }else {
    ...
    public static void setDialogStyle(Context activity, Dialog dialog, int measuredHeight, ConfigBeanRecycler bean ) {
        if (dialog == null){
            return;
        }
