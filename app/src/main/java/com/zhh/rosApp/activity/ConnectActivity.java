...
public class ConnectActivity extends ComponentActivity {

    private ActivityConnectBinding connectBinding;
    private MapMetaData mapMetaData = null;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        connectBinding = DataBindingUtil.setContentView(this, R.layout.activity_connect);
...
//                    connectBinding.mapview.setSlamLocationBeans(mList);
                ...
                if (null != localPose) {
                    connectBinding.ivMap.setRobotPose(localPose);
                    //雷达数据
                    ...
                    if (null != laserScan) {
                        ...
                        connectBinding.ivMap.setLaserScan(localLaserScan);
                    }
                ...
                if (null != homePose) {
                    connectBinding.ivMap.setHomePose(homePose);
                }
                // 机器行走时路径规划显示
                Path path = RosDeviceManager.INSTANCE.getPath();
                if (null != path) {
                    connectBinding.ivMap.setRemainingPath(path);
                }
    ...
    private void setMapData(OccupancyGrid occupancyGrid) {
        ...
        connectBinding.ivMap.setMap(map);
    }
